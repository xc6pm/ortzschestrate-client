...
const blurBackgroundOnScroll = () => {
  isBlurred.value = window.scrollY > 15
}
  ...
  <div class="text-slate-300">
    ...
    <!-- <UContainer>
      <div class="py-12 text-center">
        ...
        <ULink to="/games" class="mt-4 inline-block text-blue-500">View Games →</ULink>
      </div>
    </UContainer> -->
    ...
    <UContainer>
      <div class="py-6 text-center text-gray-300">
        ...
        <div class="flex justify-center gap-4 mt-2">
          ...
          <ULink to="/privacy" class="text-gray-300">Privacy Policy</ULink>
          <!-- <ULink to="/contact">Contact</ULink> -->
        </div>
        <div class="flex justify-center gap-4 mt-4">
          <ULink to="https://www.linkedin.com/in/hossein-ebrahimi-6a393b1b2/" target="_blank">
            <UIcon name="i-mdi-linkedin" class="w-6 h-6 text-slate-300" />
          </ULink>
          <ULink to="https://github.com/xc6pm" target="_blank">
            <UIcon name="i-mdi-github" class="w-6 h-6 text-slate-300" />
          </ULink>
          <ULink to="https://t.me/hcbrm" target="_blank">
            <UIcon name="i-mdi-telegram" class="w-6 h-6 text-slate-300" />
          </ULink>
        </div>
      </div>
    </UContainer>
